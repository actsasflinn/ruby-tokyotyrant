...
==== Meta Search (Multi Query)
  ...
  t.search(query1, query2, :union)
  # => ["book:corpus_hermeticum:chapter:13:paragraph:4", "book:corpus_hermeticum:chapter:13:paragraph:5", "book:corpus_hermeticum:chapter:13:paragraph:7", "book:corpus_hermeticum:chapter:13:paragraph:19", "book:corpus_hermeticum:chapter:13:paragraph:27", "book:corpus_hermeticum:chapter:13:paragraph:44", "book:corpus_hermeticum:chapter:13:paragraph:57", "book:corpus_hermeticum:chapter:13:paragraph:69", "book:corpus_hermeticum:chapter:13:paragraph:125", "book:corpus_hermeticum:chapter:1:paragraph:12", "...lots more ..."]

  # Get the intersection of two query sets (AND)
  t.search(query1, query2, :intersection)
  # => ["book:corpus_hermeticum:chapter:13:paragraph:5", "book:corpus_hermeticum:chapter:13:paragraph:44", "book:corpus_hermeticum:chapter:13:paragraph:69"]

  # Get the difference of two query sets (ANDNOT)
  t.search(query1, query2, :diff)
  # => ["book:corpus_hermeticum:chapter:13:paragraph:4", "book:corpus_hermeticum:chapter:13:paragraph:7", "book:corpus_hermeticum:chapter:13:paragraph:19", "book:corpus_hermeticum:chapter:13:paragraph:27", "book:corpus_hermeticum:chapter:13:paragraph:57", "book:corpus_hermeticum:chapter:13:paragraph:125"]
